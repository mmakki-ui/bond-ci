...
//         interpret the result as int32, the same wrap-safe idiom the CLIENT
//         uses for fseq (daemon/lossmeter.go:64,67,92,104 -- the ring that used
//         to be cited here was deleted in U159). A naive int64 subtraction produces

...
#     order, so EQ-1 cannot adjudicate it.  The anchor below is the sentence in
#     which pull.go RETRACTS the opposite claim -- an EARLIER revision of it
#     nominated EQ-1 as S1's adjudicator, and pull.go now says that was backwards
#     and that EQ-1 PRICES S1:  pull.go@'named EQ-1 the adjudicator of both'.
#     Adjudicating S1 is not achievable by any trace comparison anyway,

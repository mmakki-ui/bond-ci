...
// U250: DriveLit must respect the rank gate. It is the loop EVERY link runs once
// spotty-class duplication is armed, and it consulted neither the cap nor the gate, so
// arming the duplicator silently turned speed's gate off on every link.

...
//       reserved_composite.py:341  cand.sort(key=s._local_ms)  -- HUNGRIEST
...
//       reserved_composite.py:342-352 reads seq = s.fifo[0] (a PEEK), offers it,
...
//       oracle bounds on every offer (reserved_composite.py:240-241, inside the
...
// bound is the oracle's pool bound (reserved_composite.py:240-241), oldest-first,
...
// the offer block (reserved_composite.py:240-241). That is what makes the pool

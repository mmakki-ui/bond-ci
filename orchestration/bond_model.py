...
def _mut_genconf_cached(s,w,a):
    ...
    # defect bond-xctl forbids in `gl_sources` ("A cached source table would be
    # STATE the level-triggered reconciler must not keep"). Note it still branches on MODE

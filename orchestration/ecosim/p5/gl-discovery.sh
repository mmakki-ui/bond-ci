...
asrt "G12 name regex METERED_PAT gone"  "$(grep -c 'METERED_PAT' "$P5/bond-xctl")" 0
asrt "G12 name regex WIRED_PAT gone"    "$(grep -c 'WIRED_PAT' "$P5/bond-xctl")" 0

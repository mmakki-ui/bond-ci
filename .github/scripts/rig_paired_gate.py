...
def banner():
    ...
    print('  U33\'s ~0.9 pt band was PHASE ONLY and is superseded by the above, which also')
    print('  varies stall COUNT and POSITION. This is a fixed-geometry ratchet, not a')
    print('  statement about nature.')
    print('')

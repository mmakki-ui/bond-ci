...
PIN = {
    'latency_battery.py': 'b534ee9b97e48ddeee7002ef715576111008d8efd6a5f8734d4c022d711d3af4',
...
def banner():
    ...
    print('   5. The model tick is 10 ms; the shipped control loop sleeps PingIval =')
    print('      100 ms (daemon/main.go:45, slept at daemon/pullrun.go:792 -- U159')
    print('      deleted the reorder ring this line used to name). Every HOLD bar is')
    print('      scored 10x finer than the daemon resolves. r1 sec 8 asks for equality;')
    print('      it does not hold.')
    print('=' * 100)
    sys.stdout.flush()

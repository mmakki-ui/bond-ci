...
PIN = {
    'latency_battery.py': '5394f5a19a3ff4d1ad0a0b0f541afef36809c0c61778fa5bc3964ec1814a8f86',
...
def banner():
    ...
    print('   3. Every run here is GEO=canonical. What that USED to mean -- that a bar')
    print('      which became geometry-unstable would not be noticed -- no longer holds')
    print('      (U14c). The GATED/REPORTED tuples above are not taken on trust: this')
    print('      job re-derives them from the recorded rotation sample before it starts,')
    print('      and the `geometry-study` job RE-RUNS all five batteries (canonical, 3,')
    print('      7, 11, 19) and re-derives them from the runs it just made. Either arm')
    print('      exits 1 if the tuples disagree with the study, or if a rotation went')
    print('      missing (a shrinking sample flips fewer bars and WIDENS the split).')
    print('      What is still not constrained: five rotations is a SMALL sample and it')
    print('      varies PHASE only -- stall count and duration stay hand-placed (U33).')
